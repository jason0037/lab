...
class OptionsControllerTest < ActionController::TestCase
  ...
  test "should create option" do
    assert_difference('Option.count') do
      post :create, option: { index: @option.index, key: @option.key, name: @option.name, value: @option.value }
    end
  ...
  test "should update option" do
    put :update, id: @option, option: { index: @option.index, key: @option.key, name: @option.name, value: @option.value }
    assert_redirected_to option_path(assigns(:option))
  end
