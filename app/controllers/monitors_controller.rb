...
caption='行为体态监测' dataStreamURL='' refreshInterval='900' PYAxisName='体态变化值'
SYAxisName='课堂测试成绩' SYAxisMinValue='0' SYAXisMaxValue='100' setAdaptiveYMin='1' setAdaptiveSYMin='1'
showRealTimeValue='0' realTimeValuePadding='10' showLabel='1' labelDisplay='Rotate' slantLabels='1'
